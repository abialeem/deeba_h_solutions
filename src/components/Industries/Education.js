    ...
    <div className="we-help-section" style={{marginTop:'50px',marginBottom:'10px'}}>
      <div className="container" style={{paddingLeft:'150px',paddingRight:'150px'}}>
        ...
        <div className="col-lg-12" style={{textAlign:'center'}}>
            <span>INTERPRETATION SERVICES</span>
            <h2 className="section-title mb-4" style={{fontWeight:'600',fontSize:'44px'}}>Educational Interpreters For The Classroom And Beyond</h2>
      ...
      <div className="container" style={{paddingLeft:'50px',paddingRight:'50px'}}>
        <div className="row justify-content-between">
          ...
          <div className="col-lg-7" >
            ...
            <h2 className="section-title mb-4" style={{fontWeight:'600',fontSize:'44px'}}>Improve Learning Outcomes for English Language Learning Students</h2>
           <p class="has-xl-font-size" style={{
              fontSize:'20px',
              lineHeight:'30px',
            }}>
           Language shouldn’t be a barrier in education, whether you’re talking about the classroom, the research field, or the school counselor’s office.
</p>
<p class="has-xl-font-size" style={{
              fontSize:'20px',
              lineHeight:'30px',
            }}>
Zeeba H Solutions can provide you with talented interpreters in up to 200+ languages, including American Sign Language (ASL), to help you break down barriers and ensure the best possible outcome in a variety of settings.
</p>
<p class="has-xl-font-size" style={{
              fontSize:'20px',
              lineHeight:'30px',
            }}>
We’ll find you the perfect interpreter to come to your facility or connect via phone or video call to ensure that effective communication doesn’t stand in the way of educational success.
            </p>
            {/* <p><Link to="/services" className="btn">Explore Our Services</Link></p> */}
          </div>
          <div className="col-lg-5 " style={{padding:'30px',paddingLeft:'50px'}}>
          <span>OUR INTERPRETERS HELP YOU IMPROVE COMMUNICATION FOR:</span>
...
<ul className='col-12 custom-list-type1' style={{padding:'10px',fontSize:'20px'}} type='none'>
  ...
  <li style={{margin:'10px'}}> 
    <i aria-hidden="true" class="fas fa-check-circle" style={{marginRight:'10px'}}></i> 
    <span>IEP Meetings</span></li>
  <li style={{margin:'10px'}}> 
    <i aria-hidden="true" class="fas fa-check-circle" style={{marginRight:'10px'}}></i> 
    <span>Classrooms</span></li>
  <li style={{margin:'10px'}}> 
    <i aria-hidden="true" class="fas fa-check-circle" style={{marginRight:'10px'}}></i> 
    <span>Presentations</span></li>
  <li style={{margin:'10px'}}>
     <i aria-hidden="true" class="fas fa-check-circle" style={{marginRight:'10px'}}></i> 
    <span>After-school Activities</span></li>
    <li style={{margin:'10px'}}>
     <i aria-hidden="true" class="fas fa-check-circle" style={{marginRight:'10px'}}></i> 
    <span>Academic Research</span></li>
    <li  style={{margin:'10px'}}>
     <i aria-hidden="true" class="fas fa-check-circle" style={{marginRight:'10px'}}></i> 
