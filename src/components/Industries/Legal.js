...
Zeeba H Solutions's language interpreting services for Legal make it easy for you to communicate effectively with company staff and employees.
</div>
      ...
      <div className="container" style={{paddingLeft:'50px',paddingRight:'50px'}}>
        <div className="row justify-content-between">
          ...
          <div className="col-lg-7" >
            <span>LEGAL LANGUAGE INTERPRETATION</span>
            <h2 className="section-title mb-4" style={{fontWeight:'600',fontSize:'44px'}}>Could A Professional Legal Interpreter Make Your Case?</h2>
          ...
          <h4>WE’LL FIND YOU A LEGAL INTERPRETER FOR:</h4>
...
<ul className='col-12 custom-list-type1' style={{padding:'10px',fontSize:'20px'}} type='none'>
  ...
  <li style={{margin:'10px'}}> 
    <i aria-hidden="true" class="fas fa-check-circle" style={{marginRight:'10px'}}></i> 
    <span>Hearings</span></li>
  <li style={{margin:'10px'}}> 
    <i aria-hidden="true" class="fas fa-check-circle" style={{marginRight:'10px'}}></i> 
    <span>Depositions</span></li>
  <li style={{margin:'10px'}}> 
    <i aria-hidden="true" class="fas fa-check-circle" style={{marginRight:'10px'}}></i> 
    <span>Immigration Interviews</span></li>
  <li style={{margin:'10px'}}>
     <i aria-hidden="true" class="fas fa-check-circle" style={{marginRight:'10px'}}></i> 
    <span>Judicial Proceedings</span></li>
    <li style={{margin:'10px'}}>
     <i aria-hidden="true" class="fas fa-check-circle" style={{marginRight:'10px'}}></i> 
    <span>Mediations And Arbitrations</span></li>
</ul>
