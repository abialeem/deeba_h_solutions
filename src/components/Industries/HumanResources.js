...
HR Interpretation Services 
</h3>
<div  className=" cta__description  cta__content-item  content-item">
Zeeba H Solutions's language interpreting services for HR make it easy for you to communicate effectively with company staff and employees.
</div>
...
<div  className=" cta__description  cta__content-item  content-item">
Zeeba H Solutions provides certified, notarized translations for important work documentation, including: compliance, workplace safety, insurance, contracts, and more.
</div>
...
<div  className=" cta__description  cta__content-item  content-item">
Zeeba H Solutions partners with hundreds of companies across the country to verify language skills of customer service professionals.
</div>
<div  className=" cta__button-wrapper  cta__content-item  content-item ">
<span  className=" cta__button  btn ">
...
<div  className=" cta__description  cta__content-item  content-item">
Zeeba H Solutions is the chosen testing provider for medical agencies that hire personnel for foreign language services.
 </div>
<div  className=" cta__button-wrapper  cta__content-item  content-item ">
<span  className=" cta__button  btn ">
Testing <i aria-hidden="true"  className="fas fa-arrow-alt-circle-down"></i> </span>
      ...
      <div className="container" style={{paddingLeft:'50px',paddingRight:'50px'}}>
        <div className="row justify-content-between">
          ...
          <div className="col-lg-7" >
            <span>LANGUAGE PROFICIENCY TESTING</span>
            <h2 className="section-title mb-4" style={{fontWeight:'600',fontSize:'44px'}}>Is Your Staff Really Bilingual?</h2>
           <p class="has-xl-font-size" style={{
              fontSize:'20px',
              lineHeight:'30px',
            }}>
          The language access regulations in corporate revolve around one principle: organizations must provide effective communication for patients with Limited English Proficiency.
</p>
<p class="has-xl-font-size" style={{
              fontSize:'20px',
              lineHeight:'30px',
            ...
            <p class="has-xl-font-size" style={{
              ...
              Zeeba H Solutions is the leader in language testing for corporate workforce providers. Our language assessments ensure that corporate workers communicate in a language other than English in a safely and effective way. And we have the perfect test for every member of your team, whether they work at the front desk or the operating table.
            </p>

            {/* <p><Link to="/services" className="btn">Explore Our Services</Link></p> */}
          </div>
          <div className="col-lg-5 " style={{padding:'30px',paddingLeft:'20px'}}>
          <h4>Zeeba H Solutions offers language assessments based on your team’s level of corporate involvement:</h4>
...
<ul className='col-12 custom-list-type1' style={{padding:'10px',fontSize:'20px'}} type='none'>
  ...
  <i aria-hidden="true" class="fas fa-check-circle" style={{marginRight:'10px'}}></i> 
    <span>Non-technical staff, like front-desk staff and registration staff</span>
    </li>
  <li style={{margin:'10px'}}> 
    <i aria-hidden="true" class="fas fa-check-circle" style={{marginRight:'10px'}}></i> 
    <span>Special practitioners and assistants</span></li>
  <li style={{margin:'10px'}}> 
    <i aria-hidden="true" class="fas fa-check-circle" style={{marginRight:'10px'}}></i> 
    <span>Legal Teams</span></li>
  <li style={{margin:'10px'}}> 
    <i aria-hidden="true" class="fas fa-check-circle" style={{marginRight:'10px'}}></i> 
    <span>Technical Teams, Non-Technical staff, and office assistants</span></li>
  <li style={{margin:'10px'}}>
     <i aria-hidden="true" class="fas fa-check-circle" style={{marginRight:'10px'}}></i> 
    <span>Corporate interpreters (interpretation, corporate terminology and code of ethics)</span></li>
    <li style={{margin:'10px'}}>
     <i aria-hidden="true" class="fas fa-check-circle" style={{marginRight:'10px'}}></i> 
    <span>Behavioral office staff, legal, department assistants, physical & occupational therapists, and outsource partners</span></li>
</ul>
