...
Access Zeeba H Solutions network of government interpreters working in 100+ languages and dialects. 
</div>
...
<div  className=" cta__description  cta__content-item  content-item">
Zeeba H Solutions can match your documents to experienced, professional government translators.
</div>
...
<div  className=" cta__description  cta__content-item  content-item">
Zeeba H Solutions is the chosen testing provider for government agencies that hire personnel for foreign language services.
 </div>
<div  className=" cta__button-wrapper  cta__content-item  content-item ">
<span  className=" cta__button  btn ">
      ...
      <div className="container" style={{paddingLeft:'50px',paddingRight:'50px'}}>
        <div className="row justify-content-between">
          ...
          <div className="col-lg-7" >
            ...
            <h2 className="section-title mb-4" style={{fontWeight:'600',fontSize:'44px'}}>Professional and Accurate Legal Translation Services</h2>
           <p class="has-xl-font-size" style={{
              fontSize:'20px',
              lineHeight:'30px',
            }}>
          Zeeba H Solutions has extensive experience translating documents for government agencies, including the Department of Homeland Security, the Social Security Administration, and the Internal Revenue Service. As a GSA contract holder, we offer some of the lowest rates in the industry while delivering high-quality translations in more than 100 language pairs.
</p>

            {/* <p><Link to="/services" className="btn">Explore Our Services</Link></p> */}
          </div>
          <div className="col-lg-5 " style={{padding:'30px',paddingLeft:'50px'}}>
          <span>OUR PROFESSIONAL LEGAL LANGUAGE SERVICES THAT CAN HELP YOU:</span>
...
<ul className='col-12 custom-list-type1' style={{padding:'10px',fontSize:'20px'}} type='none'>
  ...
  <li style={{margin:'10px'}}> 
    <i aria-hidden="true" class="fas fa-check-circle" style={{marginRight:'10px'}}></i> 
    <span>Govt Ad Campaigns</span></li>
  <li style={{margin:'10px'}}>
     <i aria-hidden="true" class="fas fa-check-circle" style={{marginRight:'10px'}}></i> 
    <span>Mortgage Contracts</span></li>
    <li style={{margin:'10px'}}>
     <i aria-hidden="true" class="fas fa-check-circle" style={{marginRight:'10px'}}></i> 
    <span>Government Website Translation</span></li>
    <li  style={{margin:'10px'}}>
     <i aria-hidden="true" class="fas fa-check-circle" style={{marginRight:'10px'}}></i> 
    ...
    <div className="we-help-section" style={{marginTop:'50px',marginBottom:'10px'}}>
      <div className="container" style={{paddingLeft:'150px',paddingRight:'150px'}}>
        ...
        <div className="col-lg-12" style={{textAlign:'center'}}>
            <span>TRANSLATION SERVICES</span>
            <h2 className="section-title mb-4" style={{fontWeight:'600',fontSize:'44px'}}>Professional Language Services for Government</h2>
    ...
    <div className="a" style={{marginTop:'0px',paddingTop:'50px',marginBottom:'0px',paddingBottom:'20px',boxShadow: 'inset 0px 0px 10px black',background: '#3b5d50'}}>
			<div className="container-fluid">
                ...
                <div className="col-md-12 col-lg-12 mb-12 mb-lg-0 " style={{ textAlign: 'center', paddingLeft: '200px', paddingRight: '200px' }}>
                  <h2 className="mb-4 section-title" style={{ fontSize: '28px', fontWeight: 'bold',color: 'white',textTransform:'uppercase' }}>Need to translate legal documents?</h2>
