...
Access Zeeba H Solutions network of healthcare / medical interpreters working in 100+ languages and dialects. 
</div>
...
<div  className=" cta__description  cta__content-item  content-item">
Zeeba H Solutions can match your documents to experienced, professional medical translators.
</div>
...
<div  className=" cta__description  cta__content-item  content-item">
Zeeba H Solutions provides a suite of validated language tests designed specifically for the healthcare setting. Our interpreter testing exams are recognized by the leading certifying bodies for medical interpreters.
</div>
<div  className=" cta__button-wrapper  cta__content-item  content-item ">
<span  className=" cta__button  btn ">
...
<ul className='col-12 custom-list-type1' style={{padding:'10px',fontSize:'20px'}} type='none'>
  ...
  <i aria-hidden="true" class="fas fa-check-circle" style={{marginRight:'10px'}}></i> 
    <span>Non-clinical staff, like front-desk staff and registration staff</span>
    </li>
  <li style={{margin:'10px'}}> 
    <i aria-hidden="true" class="fas fa-check-circle" style={{marginRight:'10px'}}></i> 
    <span>Nurses and nursing assistants</span></li>
  <li style={{margin:'10px'}}> 
    <i aria-hidden="true" class="fas fa-check-circle" style={{marginRight:'10px'}}></i> 
    <span>Legal Brochures</span></li>
  <li style={{margin:'10px'}}> 
    <i aria-hidden="true" class="fas fa-check-circle" style={{marginRight:'10px'}}></i> 
    <span>Doctors, nurse practitioners, and physician’s assistants</span></li>
  <li style={{margin:'10px'}}>
     <i aria-hidden="true" class="fas fa-check-circle" style={{marginRight:'10px'}}></i> 
    <span>Medical interpreters (interpretation, medical terminology and code of ethics)</span></li>
    <li style={{margin:'10px'}}>
     <i aria-hidden="true" class="fas fa-check-circle" style={{marginRight:'10px'}}></i> 
    <span>Behavioral health staff, dentists, dental assistants, physical & occupational therapists, and speech therapists</span></li>
</ul>
