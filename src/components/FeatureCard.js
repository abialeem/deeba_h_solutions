...
const FeatureCard = ({ imgSrc, title, description, linkURL }) => {
    return (
      <div className="col-8 col-md-4">
        <div className="feature card card-success shadow" >
          <div className="icon">
          ...
          <div className="card-body" style={{ paddingLeft: '40px', paddingRight: '40px', paddingTop: '0px' }}>
            ...
            <Link to={linkURL} style={{ position:'relative',marginTop: '20px', left : 'center' }} className="btn btn-primary card-link learn-more-btn">LEARN MORE</Link>
          </div>
        </div>
      </div>
    );
